...
const selectedColor = '#1976D2'; // Highlight color (professional blue)
const defaultColor = '#B0BEC5'; // Default color (cool gray)

const MuscleDiagramPage = () => {
  // Define which muscles are front and which are back
  const frontMuscles = [
    'quads', 'abdominals', 'obliques', 'chest', 'traps', 'front-shoulders', 'forearms', 'hands', 'calves', 'biceps',
    // Add more front muscle keys as needed
  ];
  const backMuscles = [
    ...
    // Add more back muscle keys as needed
  ];
  ...
  const unifiedGroups = {
    'glutes-back-left': 'glutes-back',
    'glutes-back-right': 'glutes-back',
    'hamstrings-back-left': 'hamstrings-back',
    'hamstrings-back-right': 'hamstrings-back',
    'rear-shoulders-back-left': 'rear-shoulders-back',
    'rear-shoulders-back-right': 'rear-shoulders-back',
    'lats-back-left': 'lats-back',
    'lats-back-right': 'lats-back',
    'triceps-back-left': 'triceps-back',
    'triceps-back-right': 'triceps-back',
    // Front view unified groups
    'hand-left': 'hands',
    'hand-right': 'hands',
    'calves-left': 'calves',
    'calves-right': 'calves',
  ...
  function handleUnifiedPress(region) {
    setSelected(getUnifiedGroup(region));
    // You can add navigation or modal logic here
    console.log('Clicked:', getUnifiedGroup(region));
  }
...
return (
  ...
  >
    ...
    >
      ...
      {/* Title moved slightly left from center */}
      <View
        style={{
          flex: 1,
    ...
    {gender === 'male' ? (
      <>
        ...
        >
          <Svg width={svgWidth} height={svgHeight} viewBox="0 0 660.46 1206.46">
            {/* --- FULL FRONT BODY OUTLINE SVG GROUP --- */}
          <G id="body-outline-front">
            {/* Center vertical lines (spine/center) */}
            <Path d="M330.4 504.57V571.92" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M330.17 504.57V571.92" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M330.05 504.57V571.92" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            {/* Left and right body outlines and anatomical features */}
            <Path d="M29,521.95v.02c1.13,7.67,5.05,13.92,10.29,16.59,4.74,2.41,10.96,2.08,17.03-.58" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M145.75,308.53c2.76-1.9,6.01-3.82,9.75-5.55,11.35-5.19,20.97-5.55,22.92-5.6,8.44-.25,16.47-.47,22.46,4.53,10.6,8.82,7.57,27.94,6.41,35.27-.62,3.82-1.53,7.4-2.65,10.74" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M165.89,397.13c-18.42,22.99-34.28,22.87-41.87,19.05-12.72-6.41-19.87-27.43,3.8-80.98,0-.02,0-.05.02-.07" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M163.96,299.82h.04" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M174.18,297.7h.04c7.63-1.9,13.62-4.2,17.35-6.79,13.04-9.03,23.37-21.44,28.14-27.15,14.81-17.79,17.05-25.8,32.65-35.93,8.58-5.57,19.32-8.96,19.32-8.96,0,0-25.8-10.83-50.18-5.82h-.02" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M271.11,219.05c4.42-1.26,13.42-4.71,30.78-3.02,28.47,2.76,28.17,21.92,28.17,21.92v49.79c0,10.17-3.4,20.09-9.85,27.83-5.5,6.61-13.59,13.92-24.94,18.98-27.94,12.47-60.65,3.65-80.05-20.38-7.28-9.02-15.3-16.9-29.68-16.9" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M289.56,162.48v37.06c0,11.68-7.04,15.63-17.89,19.34-.54.18-1.1.36-1.67.52" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M330.05,340.19c0-16.6-24.92-9.38-34.79-5.64-10.73,4.06-19.35,8.64-22.18,15.17-3.41,7.86,3.69,12.72,4.53,33.36.22,5.38-.28,4.69-.19,15.43.09,11.2,2.29,60.48,4.34,93.33,3.22,51.71,34.57,94.43,48.29,94.43" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M286.4,377c14.08-4.19,23.65-6.71,37.6-6.43,6.05-.02,6.05-9.08,6.05-18.86" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M289.13,423.26c15.66.26,30.17.65,37.75-3.74,4.67-2.71,3.17-10.45,3.17-19.61" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M290.63,471.07c14.49.53,17.46,1.59,31.05,1.19,7.24-.55,8.38-3.7,8.38-19.3" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="
fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M387.07,881.54c.16.29.32.56.46.83,15.13,26.11,38.4,28.46,48.59,9.57,4.85-8.96,7.91-12.75,15.04-14.45" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            {/* Head, neck, and additional anatomical details */}
            <Path d="M282.69,83.67s-11.03-3.64-9.62,15.53c1.41,19.17,6.49,22.48,13.54,21.04,0,0,.56,9.8,3.39,15.57,0,0-.28,31.56-.99,39.35,0,0-9.17,9.22-14.25,11.82-5.08,2.59-25.25,10.95-30.19,13.26-4.94,2.31-12.98,9.66-14.53,10.38s-11.43,3.17-14.67,4.04c-3.24.86-40.77,3.32-54.17,48-2.26,8.22-5.08,9.95-13.26,41.8-2.82,9.22-9.31,1.01-37.1,68.03-4.09,10.09-10.16,12.4-28.92,35.46-18.76,23.06-37.53,80.63-50.04,108.21-9.99,18.48-9.43,31.75-22.35,56.69-7.46,14.93-4.33,8.55-6.29,25.23-1.96,16.68-1.54,22.28-1.33,25.62.21,3.33,5.03,20.44,5.03,20.44,0,0,10.99,1.03,8.51-13.09-2.49-14.12-.44-10.69,1.6-24.88,1.78-7.72,5.78-6.19,9.33-18.43,2.41-5.04,6.22-5.97,6.22-5.97,0,0-2.7,26.61,7.23,26.81,9.93.2,7.9-11.98,9.16-26.5,1.07-8.63,2.4-13.32,5.09-16.67,2.69-3.35,5.7-11.75.29-19.36-2.18-3.33,6.62-15.9,8.66-18.62,18.84-20.12,28.69-20.34,49.4-46.76,20.71-26.42,17.84-30.9,30.24-51.29,8.01-11.74,40.22-55.77,44.45-59.78,4.23-4.02,12.7-10.81,17.39-22.55,0,0,3.33,24.87,25.7,68.9,11.94,24.25,4.38,50.05,2.42,73.53-1.97,23.48-8.47,71.99-11.49,84.19-3.02,12.2-38.29,137.46-6.14,250.19-.32,27.05-2.52,26.73-3.78,33.82-1.26,7.09-.32,11.92-1.89,19.65-1.58,7.73-24.59,53.79-10.09,138.17,2.52,28.34,8.2,59.58,5.04,76.98-1.77,10.75-2.45,15.13-2.62,20.73-1.66,5.64-12.85,22.89-15.75,27.87-2.9,4.98-1.12,5.29-8.08,11.05-6.97,5.76-16.28,12.23-21.05,23.03-3.21,7.92-.39,11.35,3.6,11.43,0,0-.08,4.64,4.3,4.48,0,0,1.57,6.48,7.51,4.8,0,0,4.93,7.12,11.11,1.52,0,0,13.3,13.83,25.36-7.68,0,0,15.57-4.48,14.4-19.11-.16-4.72,4.54-7.2,11.11-11.03,6.57-3.84,10.8-6.8,6.97-29.43-.86-6.96.47-14.47.47-14.47,0,0,4.7-2.24,3.21-19.27-1.49-17.03-2.87-33.51,17.7-100.71,4.07-14.09,14.69-4.85,6.55-65.35-4.52-41.1-3.16-33.62,2.71-45.68,5.88-12.05,16.95-23.83,19.44-56.62,2.49-32.79,9.27-58.88,13.79-74.13,4.52-15.24,21.02-53.8,22.83-83.82.51-17.14.11-25.44,2.23-25.44" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M15.74,636.36s8.45,1.08,7.1-7.4c-1.35-8.48.36-10.41.19-18.76-.17-8.34,6.15-8.33,4.52-24.4" fill="none" stroke="#484a68" strokeWidth={3.46} strokeLinecap="round" strokeLinejoin="round" />
      ...
      >
        <Svg width={svgWidth} height={svgHeight} viewBox="0 0 660.46 1206.46">
          {/* --- FULL BACK BODY SVG --- */}
          {/* Back Head (added as requested) */}
          <G id="back-head" className="body-map__back-head">
          ...
          <G id="body-outline-back">
            ...
            <Path d="M330.26,553.71 L330.26,614.06" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth={3.52}/>
...
// Styles removed; use className props throughout the page instead.
