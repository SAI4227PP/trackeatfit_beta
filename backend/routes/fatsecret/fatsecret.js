...
const CONSUMER_KEY = "523da1c5f8bb44ebb2115101fea54ece"; // Replace with your FatSecret API Consumer Key
const CONSUMER_SECRET = "8e66f0e7b2f04f4ca47b6af96c0639db"; // Replace with your FatSecret API Consumer Secret
...
const fatsecretRequest = async (searchExpression, page = 0, maxResults = 20) => {
  const oauthParams = {
...
module.exports = { fatsecretRequest };
