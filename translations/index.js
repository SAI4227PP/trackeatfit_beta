...
export const translations = {
  en: {
    ...
    language: {
      ...
      infoText:
        "Choose your preferred language. This will change the app's interface and content language.",
  ...
  es: {
    ...
    language: {
      ...
      infoText:
        "Elige tu idioma preferido. Esto cambiará la interfaz y el contenido de la aplicación.",
      suggestedLanguages: "IDIOMAS SUGERIDOS",
      allLanguages: "TODOS LOS IDIOMAS",
      updateSuccess: "Idioma Actualizado",
      updateMessage:
        "La aplicación se reiniciará para aplicar los cambios de idioma.",
